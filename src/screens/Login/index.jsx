...
function User() {
  ...
  return (
    <>
      ...
      <FormContainer>
          ...
          <TabsContainer style={{display:"flex", flexDirection:'row', gap:'50px'}}>
            <Button 
              variant="primary" 
              type="submit" 
              style={{backgroundColor:'#384353', border:"1px solid #7EB693", width:'200px', color:'#E4CCBF'}}
              onClick={loginUser}>
              Login
            </Button>
            <Button variant="primary" 
              type="submit" 
              style={{backgroundColor:'#E4CCBF', border:'none', width:'200px', color: '#202335'}}
      ...
      <img width="100%" src="/assets/Login/Banner_Login_1.png" />
    ...
    <>
      ...
      <FormContainer>
          ...
          <Button 
              variant="primary" 
              type="submit" 
              style={{ backgroundColor:'transparent', width:'200px', color:'#202335',fontSize:'15px', border:'1px solid #384353'}}
            ...
            <Button 
              variant="primary" 
              type="submit" 
              style={{backgroundColor:'#384353', border:'none', width:'200px', color:'#E4CCBF'}}
              onClick={logoutUser}>
              Logout
            </Button>
            <Button variant="primary" 
